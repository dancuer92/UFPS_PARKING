<%-- 
    Document   : salida
    Created on : 24/06/2015, 02:15:19 AM
    Author     : Daniel
--%>
...
<body>
    ...
    <div id="contenedor">
        ...
        <div id="sesion" align="center">REGISTRO DE SALIDAS</div>

        <div id="contenido">
            <form id="formRegistrarSalida" name="formRegistrarSalida" method="post" action="RegistrarSalida.jsp"> 
