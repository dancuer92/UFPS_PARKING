...
public class ConexionPostgres {
    ...
    private static  String bd = "ufps_parking";
    private static  String login = "ufps_87";
	...
	*/
    public static ResultSet ejecutarSQL(String consultaSQL, Iterator parametros)
			throws Exception{
    	return jdbc.ejecutarSQL(consultaSQL, parametros);
    }
    ...
    public static boolean ejecutarActualizacionSQL(String comandoSQL,
    	...
    	return jdbc.ejecutarActualizacionSQL(comandoSQL, parametros);
    }
